...
public class BooksController {
    ...
    @GetMapping("/search")
    public String searchBookToPeople () {
    ...
    @PostMapping("/search")
    public String foundBookToPeople(@RequestParam(name = "query") String query,Model model){
        model.addAttribute("books", bookService.findTheRightBook(query));
